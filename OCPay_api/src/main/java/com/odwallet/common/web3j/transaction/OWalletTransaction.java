...
import static com.odwallet.common.web3j.api.EtherScanApi.*;
...
public class OWalletTransaction {
    ...
    public static BigInteger getRecentBlockNumber() {
        ...
        responseResult = responseResult.replace("/n", "");
        com.odwallet.common.web3j.response.EtherScanResponse responseToken = JSON.parseObject(responseResult, new com.alibaba.fastjson.TypeReference<com.odwallet.common.web3j.response.EtherScanResponse>() {
        });
