...
//        getWallet();
    ...
    public static void getWallet() {
        WalletFile walletFile = WillWallet.createWalletFile(walletFileString);
        try {
...
//        }
    ...
    public static void createWallet() {
        try {
            WillWallet withMnemonic = WillWallet.createWithMnemonic(password, ImToken_SEED_PATH);
...
//            AES.decrypt()
    ...
    public static void test() {
        ...
        ECKeyPair ecKeyPair1 = WillWallet.createBip44NodeFromSeed(seed, ImToken_SEED_PATH);
