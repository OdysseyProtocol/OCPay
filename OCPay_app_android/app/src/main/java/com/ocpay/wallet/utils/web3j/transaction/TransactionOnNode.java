...
//import com.ocpay.wallet.utils.web3j.bean.TransactionVerificationInfo;
//import com.ocpay.wallet.utils.web3j.response.BlockTransactionsResponse;
...
//import com.coinwallet.rechage.dao.WalletAddressNonceMapper;
//import com.coinwallet.rechage.dao.WalletGroupDetailMapper;
//import com.coinwallet.rechage.entity.WalletAddressNonce;
//import com.coinwallet.rechage.entity.WalletAddressNonceExample;
//import com.coinwallet.rechage.entity.WalletGroupDetail;
//import com.coinwallet.rechage.entity.WalletGroupDetailExample;
...
//            updateWalletAddressNonce.setNonce(nonce);
...
//            walletAddressNonce.setNonce(nonce);
...
//
//
//    public static BlockTransactionsResponse.Block getBlockByNumber(Web3j web3j, String blockNo) throws IOException {
//        try {
//            EthBlock ethBlock = web3j.ethGetBlockByNumber(DefaultBlockParameter.valueOf(new BigInteger(blockNo)), true).send();
//            if (ethBlock == null || ethBlock.getBlock() == null) {
//                return null;
//            }
//            BlockTransactionsResponse.Block newBlock = new BlockTransactionsResponse.Block();
//            BeanUtils.copyProperties(ethBlock.getBlock(), newBlock);
//            newBlock.setNumber(ethBlock.getBlock().getNumberRaw());
//            newBlock.setNonce(ethBlock.getBlock().getNonceRaw());
//            return newBlock;
//        } catch (Exception e) {
//            throw e;
//        }
