...
public class Goods  implements Serializable {
    ...
    public void setRawHighAmount(String rawHighAmount) {
        this.rawHighAmount = rawHighAmount;
    }

    public String getRawHighAmount() {
        return rawHighAmount;
    }
