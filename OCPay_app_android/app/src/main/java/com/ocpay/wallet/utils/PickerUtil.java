...
public class PickerUtil {
    ...
    public static void alertTimerPicker(Context context, TimePickerView.Type type, final String format, final TimerPickerCallBack callBack) {
        ...
        pvTime.setRange(calendar.get(Calendar.YEAR) - 100, calendar.get(Calendar.YEAR) + 80);
...
//                        tvTime.setText(getTime(date));
     ...
     * @param click
     */
    public static void alertBottomWheelOption(Context context, ArrayList<?> list, int selectIndex, final OnWheelViewClick click) {
        ...
        wv_option.setCurrentItem(selectIndex);
