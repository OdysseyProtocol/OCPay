 ...
 */
public class CustomMnemonicUtils {
     ...
     */
    public static String generateMnemonic(byte[] initialEntropy, Context context) {
        ...
        try {
            InputStream inputStream = context.getResources().getAssets().open("en-mnemonic-word-list.txt");
            WORD_LIST = readAllLines(inputStream);
        } catch (IOException e) {
            e.printStackTrace();
        }
        if (WORD_LIST == null || WORD_LIST.size() <= 0) return null;
    ...
    public static List<String> readAllLines(InputStream inp) throws IOException {
