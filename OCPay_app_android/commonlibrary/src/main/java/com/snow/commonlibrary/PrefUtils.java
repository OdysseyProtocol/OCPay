...
public class PrefUtils {
    ...
    public static void setDouble(Context context, String key, double value) {
        putLong(context, key, Double.doubleToRawLongBits(value));
    }

    /**
     * get double preferences
     *
     * @param context
     * @param key
     * @param defaultValue
    ...
    public static double getDouble(Context context, String key, double defaultValue) {
        return Double.longBitsToDouble(getLong(context, key, Double.doubleToLongBits(defaultValue)));
    }


    /**
     * put bean preferences
     *
     * @param context
     * @param key
     * @param obj
    ...
    public static void putBean(Context context, String key, Object obj) {
        if (obj instanceof Serializable) {
            try {
                ...
                putString(context, key, string64);
            } catch (IOException e) {
                e.printStackTrace();
            }
        } else {
