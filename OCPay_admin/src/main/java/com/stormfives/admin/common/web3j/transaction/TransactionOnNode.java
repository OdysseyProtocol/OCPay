...
import com.stormfives.admin.common.web3j.api.Web3JClient;
import com.stormfives.admin.common.web3j.bean.TransactionVerificationInfo;
import com.stormfives.admin.common.web3j.utils.CommonUtils;
...
import com.stormfives.admin.wallet.dao.WalletAddressNonceMapper;
import com.stormfives.admin.wallet.dao.entity.WalletAddressNonce;
import com.stormfives.admin.wallet.dao.entity.WalletAddressNonceExample;
    ...
    public static BigDecimal balanceOfContractToken(Web3j web3j, String contractAddress, String walletAddress)  {
        ...
        try {
            EthCall ethCall = web3j.ethCall(
                    ...
                    .send();
            return (ethCall == null) ? null : new BigDecimal(Hex2Decimal(ethCall.getValue()));
        }catch (Exception e){
